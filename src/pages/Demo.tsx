  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
      ...
      >
        ...
        >
          <PlayIcon className="h-10 w-10 text-primary-foreground" />
        </div>
        <h1 className="font-display text-4xl font-bold text-foreground">Prototype Demo</h1>
        <p className="text-muted-foreground leading-relaxed">
          Experience the full Find60 vision with simulated data.
          Cross-app identity, smart matching, agent battles — all mocked to showcase Tapestry's power.
        </p>
        <Button
          size="lg"
